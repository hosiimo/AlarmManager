...
public class AlarmManager
{
    ...
    /*新しく作ったAPI*/
    public void setConnect(int type, long windowStartMillis, long windowLengthMillis,
                          PendingIntent operation) {
        setImpl(type, windowStartMillis, windowLengthMillis, 0, operation, null,true);
    }
    ...
    private void setImpl(int type, long triggerAtMillis, long windowMillis, long intervalMillis,
        ...
        try {
            mService.setConnect(type, triggerAtMillis, windowMillis, intervalMillis, operation,
                    workSource,connect);
        } catch (RemoteException ex) {
        }
    }
